...
/**
  * _strnchr - return the index of the first matching character
  * @str: input string
  * @chr: target character
  * @n: max number of characters to check
  * Return: Index of the first occurence, or -1 if not found
  */
...
/**
 * _strnlen - implementing strlen with ssize_t
